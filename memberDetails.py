...
class Members:
    def __init__(self, root):
        ...
        imgfoot = Image.open(r"E:\Python\Projects\project-3-gym\img\9.jpg")
        ...
        lblimg6 = Label(self.root, text="Member Details",
        ...
        labelframeleft = LabelFrame(
            self.root, text="Member's Details", font=("times new roman", 11, "bold"), padx=2, bd=4, relief=RIDGE)
        labelframeleft.place(x=632, y=90, width=360, height=400)

        #####member details labels and entries######
        ##id##
        lblmemId = Label(labelframeleft, text="Member's Id Number", font=(
